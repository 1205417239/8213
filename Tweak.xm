...
- (void)setString:(NSString *)string {
    ...
    if (string.length) {
        ...
        [[KTClipboardManager sharedManager] addCapturedText:string bundleIdentifier:bid appName:name recordedAt:NSDate.date];
    }
}
...
- (void)setItems:(NSArray *)items {
    ...
    if (text.length) {
        NSString *bid = NSBundle.mainBundle.bundleIdentifier ?: @"";
        NSString *name = NSBundle.mainBundle.localizedInfoDictionary[@"CFBundleDisplayName"] ?: NSBundle.mainBundle.infoDictionary[@"CFBundleDisplayName"] ?: NSBundle.mainBundle.infoDictionary[@"CFBundleName"] ?: bid;
        [[KTClipboardManager sharedManager] addCapturedText:text bundleIdentifier:bid appName:name recordedAt:NSDate.date];
    }
}
